      ...
      <nav className="bg-black text-white px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8 text-sm">
            ...
            <Link href="/pages/earphones" className="text-orange-500 transition">EARPHONES</Link>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="flex flex-col md:items-end">
              <div className="flex space-x-8 text-sm mb-8">
                <Link href="/" className="hover:text-orange-500 transition">HOME</Link>
                <Link href="/category/headphones" className="hover:text-orange-500 transition">HEADPHONES</Link>
                <Link href="/category/speakers" className="hover:text-orange-500 transition">SPEAKERS</Link>
                <Link href="/category/earphones" className="hover:text-orange-500 transition">EARPHONES</Link>
              </div>
