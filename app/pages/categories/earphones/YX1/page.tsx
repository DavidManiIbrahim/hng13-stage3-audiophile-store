  ...
  const products = [
    {
      ...
      newProduct: true,
      title: "XX99 MARK II EARPHONES",
      description:
        "The new XX99 Mark II EARPHONES are the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound.",
      reverse: false,
    ...
    },
    {
      ...
      title: "XX99 MARK I EARPHONES",
      description:
        "As the gold standard for EARPHONES, the classic XX99 Mark I offers detailed and accurate sound reproduction for audiophiles, mixing engineers, and music enthusiasts alike.",
      reverse: true,
      href: '/pages/categories/EARPHONES/xx99mark1',
    },
    {
      id: 3,
      image: "/assets/image-removebg-preview(48).png",
      title: "XX59 EARPHONES",
      description:
        "Enjoy your audio almost anywhere and customize it to your specific tastes with the XX59 EARPHONES. The stylish yet durable design makes them a perfect companion at home or on the go.",
      reverse: false,
      href: '/pages/categories/EARPHONES/xx59',
    },
  ];
