...
export default function AudiophileYX1EarphonesPage() {
      ...
      <main className="max-w-7xl text-black mx-auto px-6 lg:px-12">
        ...
        <section className="grid lg:grid-cols-2 gap-16 py-8 mb-20">
          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            <p className="text-lg font-bold tracking-wider">$ 599</p>
        ...
        <section className="grid lg:grid-cols-5 gap-16 lg:gap-24 py-16 mb-20">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 text-gray-600 text-base leading-relaxed">
              <p>
               Experience unrivalled stereo sound thanks to innovative acoustic technology. With
               improved ergonomics
              </p>
              <p>
